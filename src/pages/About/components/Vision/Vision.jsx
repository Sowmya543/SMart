...
const Vision = () => {
    return (
        <div className='vision'>
            ...
            <h1>Meet the Team</h1>
            <p>We’re designers, developers, and dreamers passionate about solving everyday problems
                with code <span></span>and creativity. Your feedback fuels our improvements — <span></span>and your satisfaction
